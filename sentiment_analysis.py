...
def main():
    ...
    for i in range(1,6):
        file_name = "text_data/office_first_helpfulness/" + str(i) + "starreviews.txt"
    ...
    generate_graph([positive_word_ratio, negative_word_ratio], "Office Supplies with Helpfulness and First Word")
